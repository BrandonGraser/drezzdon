      ...
      <div className="absolute inset-0 flex items-center justify-center px-4">
        ...
        >
          ...
          <h2
            ...
            style={{ color: "#ff0000", fontSize: "clamp(1.4rem, 4vw, 2.2rem)", fontFamily: "'acumin-pro', sans-serif", fontWeight: 700, transform: "scaleY(1.2)", display: "block" }}
          >
            biz@drezzdon.com
          </h2>
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs tracking-widest uppercase" style={{ color: "#ff0000", fontFamily: "'acumin-pro', sans-serif" }}>
              First Name <span style={{ color: "#ff0000" }}>*</span>
            </label>
            <input
              type="text"
              required
              className="bg-transparent border-b outline-none text-white py-1 text-sm"
              style={{ borderColor: "#ff0000", fontFamily: "'acumin-pro', sans-serif" }}
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea
              required
              rows={3}
              className="bg-transparent border-b outline-none text-white py-1 text-sm resize-none"
              style={{ borderColor: "#ff0000", fontFamily: "'acumin-pro', sans-serif" }}
              onMouseEnter={hoverOn} onMouseLeave={hoverOff}
            />
          </div>
          ...
          <button
            type="button"
            className="mt-2 py-3 text-xs tracking-[0.25em] uppercase font-bold transition-transform duration-200 hover:scale-105"
