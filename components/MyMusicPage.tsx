...
const META = [
  { id: "spotify",          label: "Spotify",          href: "https://open.spotify.com/artist/4a10dwuUNwm8ae6aSnQLUH/discography/all" },
  { id: "apple-music",      label: "Apple Music",      href: "https://music.apple.com/us/artist/drezzdon/1725878392" },
  { id: "amazon-music",     label: "Amazon Music",     href: "https://music.amazon.com/artists/B0CSM6CT49/drezzdon" },
  { id: "youtube",          label: "YouTube",          href: "https://www.youtube.com/channel/UCyYl8kRx1FSkBU8SN9sxSDg" },
  { id: "spotify-playlist", label: "Spotify Playlist", href: "https://open.spotify.com/playlist/5OnMV2Vt4Yyw8pn9OV05tc?si=d8c82649f92943d0" },
];

const INIT_DESKTOP = [
  { id: "spotify",          top: 14.8, left: 54.3, width: 12.6, height: 9.3  },
  { id: "apple-music",      top: 65.9, left: 51.5, width: 16.4, height: 11.4 },
  { id: "amazon-music",     top: 19.7, left: 74.3, width: 21.9, height: 7.8  },
  { id: "youtube",          top: 74.5, left: 76.6, width: 17.2, height: 9.4  },
  { id: "spotify-playlist", top: 38.7, left: 55.5, width: 36.6, height: 21.5 },
];

const INIT_MOBILE = [
  { id: "spotify",          top: 62.8, left: 7.6,  width: 24.4, height: 6.5  },
  { id: "apple-music",      top: 77.8, left: 8.6,  width: 36.2, height: 6.9  },
  { id: "amazon-music",     top: 59.6, left: 47.6, width: 39.8, height: 7.2  },
  { id: "youtube",          top: 73.4, left: 55.0, width: 33.6, height: 6.4  },
  { id: "spotify-playlist", top: 43.8, left: 16.0, width: 68.0, height: 12.7 },
];
...
export default function MyMusicPage() {
  ...
  const videoSrc  = isMobile
    ? `/api/video?src=${encodeURIComponent("https://www.dropbox.com/scl/fi/z2qccpgw8nh1iudgz0v5q/MY-MUSIC-9-16.mp4?rlkey=hmop7lv9z00zh27m62pgjqat4&raw=1")}`
    : `/api/video?src=${encodeURIComponent("https://www.dropbox.com/scl/fi/cc9a6onki13h9ficxrlhn/MY-MUSIC-16-9.mp4?rlkey=zwyacgapeams6pash06ewepig&raw=1")}`;
      ...
      {dims && !DEBUG && activePos.map((pos) => {
        ...
        return (
          <a
            ...
            className="absolute"
            style={{ left, top, width, height, cursor: "none" }}
