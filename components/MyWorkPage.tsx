    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      >
        ...
        <ul className="flex gap-9 list-none">
          <li><Link href="/my-work" className="text-xs tracking-[0.18em] uppercase text-white transition-colors duration-200">My Work</Link></li>
          <li><Link href="/contact" className="text-xs tracking-[0.18em] uppercase text-white/60 hover:text-white transition-colors duration-200">Contact</Link></li>
      ...
      <main className="pt-36 pb-20 px-12 max-w-6xl mx-auto" style={{ animation: "fadeUp 0.6s ease forwards" }}>
        <h1 className="text-7xl font-light tracking-tight mb-12">My Work</h1>
